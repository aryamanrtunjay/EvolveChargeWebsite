  ...
  try {
    ...
    const htmlContent = `
      ...
      <head>
        ...
        <title>Welcome to Ampereon</title>
        <style>
          body {
      ...
      <body>
        <div class="email-container" style="font-family: Arial, sans-serif; max-width: 600px; margin: auto;">
            <div class="email-header" style="text-align: center; padding: 20px; background-color: #f5f5f5;">
                <img src="https://evolve-charge.com/images/LogoWhite.png" alt="Ampereon Logo" style="max-width: 200px;">
            </div>
            <div class="email-body" style="padding: 20px;">
                <p class="greeting" style="font-size: 18px;">Hello ${firstName || 'there'},</p>
                <h1 style="color: #333;">Welcome to Ampereon Community!</h1>
                ...
                <h2 style="color: #333;">Introducing Ampereon</h2>
                ...
                <ul>
                    ...
                    <li><strong>Smart Home Integration:</strong> Manage charging times, monitor energy usage, and control via Ampereon mobile app.</li>
                </ul>
                
                <div style="text-align: center; margin-top: 20px;">
                    <a href="https://evolve-charge.com/#how-it-works" style="display: inline-block; background-color: #007bff; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View Ampereon</a>
                </div>
            ...
            <div class="email-footer" style="text-align: center; padding: 10px; background-color: #f5f5f5; font-size: 12px;">
                ...
                <p>This email was sent to you because you signed up for Ampereon mailing list on ${currentDate}.</p>
            </div>
        </div>
    </body>
    ...
    const textContent = `
      ...
      © ${new Date().getFullYear()} Ampereon. All rights reserved.
      Sammamish, WA
      
      To unsubscribe, contact: support@evolve-charge.com
      
      This email was sent to you because you signed up for Ampereon mailing list on ${currentDate}.
    `;

    // Email options
    const mailOptions = {
      from: `"Ampereon" <notifications@evolve-charge.com>`,
      to: email,
      subject: `Welcome to Ampereon, ${firstName || 'EV Enthusiast'}!`,
      text: textContent,
      html: htmlContent,
    };
