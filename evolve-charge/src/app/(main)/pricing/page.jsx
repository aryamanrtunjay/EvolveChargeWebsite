...
export default function Pricing() {
  ...
  const faqItems = [
    ...
    {
      question: "What happens if the EVolve Charger needs repair?",
      answer: "If your The EVolve Charger needs repair, our support team will first attempt remote diagnostics. If the issue can't be resolved remotely, we'll send a technician to repair or replace your unit at no additional cost, provided the issue is covered under warranty and not caused by misuse or damage."
    }
  ];
