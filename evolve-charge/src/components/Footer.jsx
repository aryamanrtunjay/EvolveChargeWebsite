    ...
    <footer className="bg-gray-800 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent">
              EVolve Charge
            </h3>
            ...
            <div className="flex space-x-4">
              {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                <a key={social} href="#" className="text-gray-300 hover:text-teal-400 transition-colors">
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button 
                type="submit"
                className="px-4 py-2 rounded-r-full bg-gradient-to-r from-teal-400 to-cyan-500 text-white font-medium"
              >
                Subscribe
              </button>
            </form>
