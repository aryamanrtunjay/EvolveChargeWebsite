          ...
          >
            ...
            >
              ...
              <div className="prose prose-teal prose-sm max-w-none text-gray-700">
                 ...
                 <p className="mb-3">The Website is provided for informational purposes regarding our products and services and to facilitate pre-orders of the EVolve Charger. You may use the Website solely for lawful purposes and in accordance with these Terms. Unauthorized use, including but not limited to attempts to interfere with the Website’s functionality, is strictly prohibited.</p>
 
                 <h3 className="font-bold">3. Pre-Orders and Payment</h3>
                 <p className="mb-3">Pre-orders for the EVolve Charger are subject to a one-time fee, payable at the time of order placement. No fees are charged for general Website access. Early-bird pricing is available on a limited basis. All payments are final upon processing, except in cases where EVolve Charge is unable to fulfill the order, in which event a refund may be issued at our discretion.</p>
